...
def validate_api_last_core_contract(root: Path = ROOT) -> list[str]:
    ...
    _require_text(
        ...
        required=[
            ...
            "replayLab.enterprise_shadow_providers",
            "Enterprise shadow provider contracts",
            "raw_payloads_saved",
            "provider_cursors_replayed",
            "provider_latency_saved",
...
def main() -> int:
    ...
    if hermes_script.exists():
        ...
        for required in [
            ...
            "buildRuntimeFixPlan",
            "buildOperatorChannelBootstrapPacket",
            "buildSourceRouteLedger",
            "buildSourceRouteLedgerReport",
            "buildAutonomyGates",
            "buildExperimentLab",
            ...
            "REDACTED_API_KEY",
            "runtime_findings",
            "operator_channel_bootstrap",
            "source_route_ledger",
            "route_command_executed",
            "bypass_attempted",
            "automated_env_write_allowed",
            "manual_env_write_required",
            "gateway_service_stopped",
            "doctor_timed_out",
            "mutates_runtime_if_run",
            "buildPlaybook",
            "buildLiveStats",
            "buildLiveWindow",
            "buildMatchPulse",
            ...
            "safe_repair_queue",
            "normalizeLiveControllerLedgerRecord",
            "deriveLiveControllerLedgerBlockers",
            "blocked_throttle_count",
            "top_feedback_blocker",
            "top_feedback_next_action",
            "feedback_repair_ready",
            ...
            "buildLiveRepairPlan",
            "buildLiveRepairPlanPreview",
            "buildLiveRepairAlignment",
            "controllerFromLiveControllerLedgerRecord",
            "liveControllerFeedbackActionForId",
            "repair_alignment",
            "live_repair_plan",
            "live_repair_plan_preview_present",
            "live_repair_alignment_requires_review",
            "live_repair_alignment_status",
            "live_repair_alignment",
            "repair_plan_provider_commands",
            "repair_plan_paper_orders",
            "controller_priority_differs_from_repeated_feedback",
            "recommended_repair_id",
            "selected_matches_top_feedback_action",
            "selected_addresses_top_feedback_blocker",
            "buildLiveRepairLedger",
            "buildLiveRepairLedgerReport",
            "live-repair-plan",
            "live-repair-ledger",
            "live-repair-ledger-report",
            "local_live_repair_jsonl_only",
            "repair_command_executed_count",
            "provider-smoke-ledger",
            "provider-smoke-ledger-report",
            "local_provider_smoke_jsonl_only",
    ...
    for required in [
        ...
        "hermes:playbook",
        "hermes:live-stats",
        "live_stats_feature_contract",
        "LiveFeatureSnapshotSeed",
        "CollectionCadenceSeed",
        "SignalGateContextSeed",
        "LearningReviewSeed",
        "internal_api_only",
        "browser_scraping_allowed",
        "llm_per_tick_allowed=false",
        "feature_contract_status",
        "freeze_feature_ingestion",
        "repair_live_feature_contract",
        "hermes:live-window",
        "hermes:match-pulse",
        "hermes:collection-plan",
        "hermes:quota-plan",
        "hermes:learning-review",
        "hermes:budget-chain",
        "hermes:provider-smoke",
        "hermes:provider-smoke-ledger",
        "hermes:provider-smoke-ledger-report",
        "hermes:safe-loop",
        "hermes:autonomy-brief",
        "hermes:source-discovery",
        "hermes:source-route-matrix",
        "hermes:source-route-ledger",
        "hermes:source-route-ledger-report",
        "hermes:replay-backfill-contract",
        "hermes:source-use-manifest",
        "hermes:source-use-ledger",
        "hermes:source-use-ledger-report",
        "hermes:source-intake-plan",
        "hermes:source-intake-ledger",
        "hermes:source-intake-ledger-report",
        "hermes:enterprise-readiness",
        "hermes:trigger-policy",
        "hermes:ops-compiler",
        ...
        "provider_quota_spend_allowed_from_this_command",
        "can_submit_real_orders=false",
        "llm_per_tick_allowed=false",
        "provider_api_call_allowed=false",
        "runtime_findings",
        ...
        "operator_channel_bootstrap",
        "source-route-ledger",
        "source-route-ledger-report",
        "replay-backfill-contract",
        "source-use-manifest",
        "source-use-ledger",
        "source-use-ledger-report",
        "source-intake-plan",
        ...
        "cc0_candidate_verify",
        "public_terms_operator_review",
        "paid_api_terms",
        "match_charting_project",
        "kaggle_tennis_cc0_candidates",
        "source_intake_plan",
        "source_intake_plan.mode=source_intake_plan",
        "live_stats_feature_intake_contract",
        "intake_contracts",
        "allowed_contract_detail_ids",
        "allowed_contract_detail_counts",
        "top_allowed_contract_detail",
        ...
        "replay_backfill_to_operational_truth",
        "ReplayBackfillEvidence",
        "/api/v1/replay/backfill-evidence",
        "ReplayBackfillEvidence",
        "replay_backfill_seed_status",
        "replay_backfill_seed_count",
        "can_use_replay_backfill_for_rehearsal",
        "can_promote_model_from_replay_seeds",
        "closing_line_proxy_seed_ready",
        "paper_learning_seed_ready",
        "signal_gate_regression_ready",
        "backend_replay_backfill_evidence.status=ready",
        "replay_backfill_seeds_rehearsal_only",
        "local_source_intake_ledger",
        "use_source_intake_allowed_contract_when_it_proves_route_replay_backfill",
        "source_intake_pressure",
        "source_use_manifest",
        "source_use_ledger_report",
        "source_use_records",
        "source_use",
        "local JSONL",
